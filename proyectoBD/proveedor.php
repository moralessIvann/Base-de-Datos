...
include("includeQuery/insertarProveedor.php")
 ...
 ?>
 	  ...
 	  <div class="container">
        ...
        <div class="row">
        	...
        	<div class="col s12 center-align"><h1>Proveedor</h1></div>
        </div>
		  ...
		  <input  type="number"  name="idProveedor" placeholder="Ingrese id de proveedor" id="idProveedor"  min="0" class="validate" required>
		  ...
		  <input placeholder="Ingrese número de tel" id="Tel" name="Tel" type="text" class="validate" required>
         
          <label for="textarea6"> </label>
		 
		 
		  <input placeholder="Ingrese nombre de empresa" id="Empresa" name="Empresa" type="text" class="validate" required>
          ...
          <input type="submit" name="boton" id="registrar"   value="borrar" class="waves-effect waves-light btn"/>
            ...
            <iframe src="includeQuery/tablaProveedor.php" width="100%" height="500px" frameborder="0">
